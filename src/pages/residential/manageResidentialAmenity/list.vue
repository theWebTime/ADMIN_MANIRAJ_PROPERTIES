    ...
    <VCard>
      <VCardText class="d-flex flex-wrap py-4 gap-4">
        ...
        <div class="app-user-search-filter d-flex align-center flex-wrap gap-4">
          <router-link
            :to="'/residential/manageResidentialAmenity/add/' + this.paramsId"
          >
            <VBtn prepend-icon="tabler-plus"> Add Residential Amenity </VBtn>
          </router-link>
        </div>
      </VCardText>
      <VDivider />
        ...
        <v-data-table class="text-no-wrap" fixed-header>
          <thead>
            <tr>
              ...
              <th class="text-uppercase text-center">Amenity</th>
